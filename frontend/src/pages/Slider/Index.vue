  ...
  <q-page class="q-pb-xl" :class="{ 'flex flex-center': !sliders.available }">
    <q-header>
      <q-toolbar>
        ...
        <q-btn class="gt-xs" color="grey-1" text-color="grey-9" icon="eva-plus-circle" label="Tambah Slider" no-caps
          @click="handleBtnUpload" />
      </q-toolbar>
    </q-header>
        ...
        <q-list separator>
          <q-item v-for="slider in sliders.data" :key="slider.id">
            <q-item-section top avatar>
              <img :src="slider.src" class="img-thumb" />
            </q-item-section>
            <q-item-section top>
