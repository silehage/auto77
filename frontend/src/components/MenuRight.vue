    ...
    <q-dialog v-model="shareModal" position="bottom">
      <q-card class="card-medium">
        <q-card-section>
          ...
          <div class="q-gutter-md" style="min-height:100px;">
            <q-btn @click="shareNow('facebook')" icon="eva-facebook" round color="fb"></q-btn>
            <q-btn @click="shareNow('twitter')" icon="eva-twitter" round color="twitter"></q-btn>
            <q-btn @click="shareNow('whatsapp')" round color="green">
